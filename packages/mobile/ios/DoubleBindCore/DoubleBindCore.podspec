Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
    ...
    GraphDB interface used across all Double-Bind platforms, and provides a
    React Native native module for JavaScript integration.
  DESC
  ...
  # React Native integration for native module support
