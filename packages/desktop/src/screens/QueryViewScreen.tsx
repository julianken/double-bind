...
const styles = {
  ...
  toolbar: {
    ...
    backgroundColor: 'var(--surface-recessed, #f9fafb)',
    flexShrink: 0,
  },
  toolbarGroup: {
    display: 'flex',
  ...
  modeButton: (isActive: boolean) => ({
    ...
    backgroundColor: isActive ? 'var(--color-primary, #3b82f6)' : 'var(--surface-base, white)',
  ...
  sidePanelTab: (isActive: boolean) => ({
    ...
    padding: '10px 12px',
    border: 'none',
    backgroundColor: isActive ? 'var(--surface-base, white)' : 'transparent',
